...
\begin{figure}[htp]
  ...
  \subfloat[\zdom{} feature importance]{
    \includegraphics[width=0.7\textwidth]{figures/VH/VH_feature_importance_zdom.pdf}\label{fig:wh_feature_importance_zdom}
  }
  \hfill
  \subfloat[\zdep{} feature importance]{
    \includegraphics[width=0.7\textwidth]{figures/VH/VH_feature_importance_zdep.pdf}\label{fig:wh_feature_importance_zdep}
  }
