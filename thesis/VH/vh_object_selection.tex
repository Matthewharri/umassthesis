...
Electrons in the 3$\ell$ channel use the ``TightLH'' identification and ``Tight\_VarRad'' isolation WP's while electrons in the 4$\ell$ use the ``MediumLH'' identification and ``Loose\_VarRad'' WP's\@. Both channels require electrons to have $\pt{} > 15$~GeV. Different from previous analyses, electrons that are reconstructed as ambiguous (e.g.\ cannot be distinguished from a photon) are kept in the analysis, as well as electrons in the transition region ($1.37 < |\eta| < 1.52$), extending electron coverage to the full $|\eta| < 2.47$.
