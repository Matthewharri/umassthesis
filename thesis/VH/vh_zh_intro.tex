...
The $\zh{} \to ZWW^{*} \to \ell\ell\ell\nu\ell\nu$ analysis requires the presence of exactly four isolated leptons (muons or electrons, including those from $\tau$ decays) with $\pt > 10$~GeV, a total charge of zero, and at least one lepton matched to the trigger object.
...
Dedicated ANNs are used in this analysis the enhance sensitivity with respect to a purely cut-based analysis. The one SFOS and two SFOS channels have different ANNs which are optimized for their respective regions.