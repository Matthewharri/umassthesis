...
Dedicated ANNs are used in this analysis the enhance sensitivity with respect to a purely cut-based analysis. The one SFOS and two SFOS channels have different ANNs which are optimized for their respective background composition.