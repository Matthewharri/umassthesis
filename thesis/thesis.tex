...
\section{Introduction}\label{sec:statistical_analysis_intro}
...
\section{Binning}
\section{Inclusive Measurement Expected Results}\label{sec:statistical_analysis_expected_results}
\subsection{\zdom{} Expected Results}\label{sec:statistical_analysis_zdom_expected_results}
\subsection{\zdep{} Expected Results}\label{sec:statistical_analysis_zdep_expected_results}
\subsection{\wh{} Expected Results}\label{sec:statistical_analysis_wh_expected_results}
\subsection{$VH$ Expected Results}\label{sec:statistical_analysis_vh_expected_results}
\subsection{Run 2 and Run 3 Combined Expected Results}\label{sec:statistical_analysis_combined_expected_results}
\section{Inclusive Measurement Observed Results}\label{sec:statistical_analysis_observed_results}
\subsection{\zdom{} Observed Results}\label{sec:statistical_analysis_zdom_observed_results}
\subsection{\zdep{} Observed Results}\label{sec:statistical_analysis_zdep_observed_results}
\subsection{\wh{} Observed Results}\label{sec:statistical_analysis_wh_observed_results}
\subsection{$VH$ Observed Results}\label{sec:statistical_analysis_vh_observed_results}
\subsection{Run 2 and Run 3 Combined Observed Results}\label{sec:statistical_analysis_combined_observed_results}
\section{STXS Measurement Expected Results}\label{sec:statistical_analysis_stxs_expected_results}
\section{STXS Measurement Observed Results}\label{sec:statistical_analysis_stxs_observed_results}
