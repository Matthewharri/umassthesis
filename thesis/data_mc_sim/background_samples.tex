...
The electroweak diboson processes, $WZjj$ and $ZZjj$, are generated at LO precision with Sherpa 2.2.14 for zero and one jet multiplicities and include triboson-like diagrams. The triboson-like diagrams are due to overlap with processes such as $ZWW$ and $ZZW$ where they decay to $\ell\nu\ell\nu jj$. The $gg \rightarrow ZZ$ sample is generated at NLO QCD precision and uses the NNPDF3NLO PDF set. To improve modeling in the low invariant mass region, additional complementary low-mass $WZ$ and $ZZ$ samples are produced at NLO for 0-jet multiplicity and LO for one or two jets.
...
\begin{table}
  ...
  \begin{tabular}{l|l|l|l|l|l|l}
    ...
    \hline
  \end{tabular}
  \caption{List of event generators, parton showering and tuning used for each background process. The cross sections, kFactors, and filter efficiencies calculated during the event generation are also listed.}\label{tab:mc_background_samples}
\end{table}