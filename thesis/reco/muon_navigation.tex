...
\begin{figure}[htp]
  ...
  \caption{An example of an octree with its subdivisions into octants~\cite{geidav2014octrees}.}\label{fig:reco_acts_muon_octree}
\end{figure}
...
\begin{figure}[htp]
  ...
  \caption{An example frustum as seen in ACTS\@. It is essentially a cone-like object. More sides can be added.}\label{fig:reco_acts_frustum}
\end{figure}
