...
\begin{figure}[htp]
  ...
  \hfill
  \subfloat[MDT sensitive elements in Gen 2 Geometry]{
  ...
  \caption{Left: the full Muon Gen 2 geometry. Right: the interior of an MDT chamber showing sensitive elements such as drift tubes.}\label{fig:reco_acts_muon_and_sensitives_gen2}
\end{figure}
