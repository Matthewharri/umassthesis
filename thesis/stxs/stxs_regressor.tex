...
\begin{figure}[htbp]
    ...
    \caption{Validation plots of the regression NN in the \zdom{} VR (a), the \zdom{} top VR (b), and the \zdep{} top VR (c). Good data-MC simulation agreement is seen.}\label{fig:VR_regressor_val}
\end{figure}